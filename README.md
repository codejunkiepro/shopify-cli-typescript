# Shopify App Template - Typescript
...
- [Express](https://expressjs.com/) builds the backend with Typescript.
- [Vite](https://vitejs.dev/) builds the [React](https://reactjs.org/) frontend with Typescript.
...
```shell
git clone https://github.com/ninjaoshima/shopify-cli-typescript.git
cd shopify-cli-typescript
```
